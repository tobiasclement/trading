...
class Train(BaseTrain):
    def __init__(self,
        ...
        self.policy_net = DQN(number_of_index,data_train.state_size, 3).to(device)
        self.target_net = DQN(number_of_index,data_train.state_size, 3).to(device)
        self.target_net.load_state_dict(self.policy_net.state_dict())
        self.target_net.eval()

        self.optimizer = optim.Adam(self.policy_net.parameters())

        self.test_net = DQN(number_of_index,self.data_train.state_size, 3)
