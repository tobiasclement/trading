...
# correction Robert: original file with BTC, AAPL,...,AMD in comments and adjustment to MSFT

#DATASET_NAME = 'MSFT'
#DATASET_FOLDER = r'MSFT'
#FILE = r'MSFT.csv'
#data_loader = YahooFinanceDataLoader(DATASET_FOLDER, FILE, '2023-01-31', begin_date='2017-01-03', end_date='2023-05-04', load_from_file=False)
