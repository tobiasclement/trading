...
class BaseTrain:
    ...
    def select_action(self, number_of_index, state):
    ...
    def train(self, number_of_index, num_episodes=50, tensorboard=None):
        ...
        for i_episode in tqdm(range(num_episodes)):
            ...
            for t in count():
                ...
                action = self.select_action(number_of_index, state)
