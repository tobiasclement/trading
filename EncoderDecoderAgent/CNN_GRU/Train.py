...
class Train(BaseTrain):
    def __init__(self,
        ...
        #print(window_size,hidden_size,device)
        device = 'cpu'
        self.encoder = Encoder(number_of_index, window_size, hidden_size, device)
        ...
        test_encoder = Encoder(number_of_index, self.window_size, hidden_size, device).to(device)
