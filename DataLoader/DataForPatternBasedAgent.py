...
class DataForPatternBasedAgent(Data):
    def __init__(self, number_of_index, data, patterns, action_name, device, gamma, n_step=4, batch_size=50, transaction_cost=0.0):
        """
        ...
        super().__init__(number_of_index, data, action_name, device, gamma, n_step, batch_size, transaction_cost=transaction_cost)
